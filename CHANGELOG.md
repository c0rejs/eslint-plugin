...
- chore: remove @zdm npm registry (● [ed438be](https://github.com/corejslib/eslint-plugin/commit/ed438be); 👬 zdm)

Compare with the previous release: [v1.7.41](https://github.com/corejslib/eslint-plugin/compare/v1.7.41...v1.7.42)
...
Compare with the previous release: [v1.7.39](https://github.com/c0rejs/eslint-plugin/compare/v1.7.39...v1.7.40)
...
- chore(metadata): update package metadata (● [df546d8](https://github.com/c0rejs/eslint-plugin/commit/df546d8); 👬 zdm)

Compare with the previous release: [v1.7.37](https://github.com/c0rejs/eslint-plugin/compare/v1.7.37...v1.7.38)
...
- \[PATCH] fix: update npmrc (● [29d0514](https://github.com/c0rejs/eslint-plugin/commit/29d0514); 👬 zdm)

**Other changes:**

- build: migrate to c0rejs namespace (● [9eabc41](https://github.com/c0rejs/eslint-plugin/commit/9eabc41); 👬 zdm)

- docs: update docs (● [1376d41](https://github.com/c0rejs/eslint-plugin/commit/1376d41); 👬 zdm)

Compare with the previous release: [v1.7.35](https://github.com/c0rejs/eslint-plugin/compare/v1.7.35...v1.7.36)
